...
test('recusa duplicatas e supervisor ausente',()=>{const r=parseTeamRows([headers,['A','a@x.com','Promotor','1','s@x.com'],['B','a@x.com','Promotor','1','s@x.com']]);assert.ok(r.errors.length>=3);});
